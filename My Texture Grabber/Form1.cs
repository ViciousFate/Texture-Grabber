...
namespace Texture_Grabber
{
    public partial class Form1 : Form
    {
        ...
        string PictureUrl = "realmofthemadgodhrd";
        int viewLimit = 1000;
        ...
        public Form1()
        {
            ...
            realItems = new ListViewItem[1000];
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string result = wc.DownloadString("http://" + PictureUrl + ".appspot.com/picture/list?num=" + viewLimit + "&tags=" + textBox1.Text);
        ...
        private void radioButton4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (radioButton2.Checked)
                PictureUrl = "realmofthemadgodhrd";
        }
    ...
    public class LVTag
    {
        ...
        {
            if (Testing)
                return "rotmgtestinghrd";
            else
                return "realmofthemadgodhrd";
        }
    }
}
